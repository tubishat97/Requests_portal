            ...
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Update airport')}}</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="card ">
                <div class="card-header">
                    <h3>{{ __('Update airport')}}</h3>
                </div>
                <div class="card-body">
                    <form enctype="multipart/form-data" method="POST" action="{{ route('admin.airport.update', $airport->id) }}">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    ...
                                    <input type="hidden" id="lat" name="lat"
                                        ...
                                        value="{{$airport->lat}}">
                                    <input id="pac-input" name="city_location" class="form-control" type="text" value="{{ $airport->city_location }}"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" id="name" name="name" value="{{ $airport->name }}"
