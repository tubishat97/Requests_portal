            ...
            <div class="col-lg-4">
                <nav class="breadcrumb-container" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">{{ __('Add flight')}}</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="card ">
                ...
                <div class="card-body">
                    <form enctype="multipart/form-data" method="POST" action="{{ route('admin.flight.store') }}">
                        @csrf
                        <hr class="cm-bold">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    null, [ 'class' => 'form-control select2', 'placeholder'=> 'airlines']) !!}
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    null, [ 'class' => 'form-control select2', 'placeholder'=> 'airplanes'])
                                    !!}
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    null, [ 'class' => 'form-control select2', 'placeholder'=> 'airports']) !!}
                                    <div class="help-block with-errors"></div>
                                </div>
                            </div>
                            <div class="col-md-6">
