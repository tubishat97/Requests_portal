...
return [
    ...
    "a_copy_of_a_notification_of_the_event_of_death_in_which_the_main_cause_of_death_and_the_circumstances_surrounding_it_are_mentioned" => "A copy of a notification of the event of death, in which the main cause of death and the circumstances surrounding it are mentioned",
    "an_original_medical_report_showing_the_cause_of_death" => "An original medical report showing the cause of death",
    "police_report_in_case_of_death_due_to_accident" => "Police report in case of death due to accident",
    "a_statement_of_account_for_the_borrower_showing_the_balance_of_the_loan_when_the_claim_occurs" => "A statement of account for the borrower showing the balance of the loan when the claim occurs",
    "loan_repayment_schedule" => "loan repayment schedule",
    "any_other_necessary_documents_required_by_the_company" => "Any other necessary documents required by the company",
